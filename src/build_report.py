...
def load_data() -> dict[str, pd.DataFrame]:
    return {
        ...
        "positions": pd.read_csv(DATA_DIR / "player_positions.csv"),
        "zones": pd.read_csv(DATA_DIR / "attacking_zones.csv"),
        "league": pd.read_csv(DATA_DIR / "league_team_stats.csv"),
        ...
        "touches": pd.read_csv(DATA_DIR / "player_touches.csv"),
        "final_shots": pd.read_csv(DATA_DIR / "final_shots.csv"),
        "all_shots": pd.read_csv(DATA_DIR / "all_shots.csv"),
        "momentum": pd.read_csv(DATA_DIR / "final_momentum.csv"),
